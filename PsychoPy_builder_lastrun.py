...
expName = 'MonitiorTime_builder_online_20220510'  # from the Builder filename that created this script
expInfo = {'participant': '', 'hz': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jiyeon/Library/CloudStorage/GoogleDrive-stopdelay@g.cbnu.ac.kr/My Drive/Jiyeon/Program/20220509_MonitorTime_matlab-psychopy/MonitiorTime_builder_online_20220510_lastrun.py',
...
target = visual.ImageStim(
    ...
    image='face01.bmp', mask=None, anchor='center',
...
text = visual.TextStim(win=win, name='text',
    text='',
    font='Open Sans',
    units='pix', pos=(0, 250), height=20.0, wrapWidth=None, ori=0.0, 
...
mask = visual.ImageStim(
    win=win,
    name='mask', units='pix', 
    image='mask.bmp', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(300, 400),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
for thisTrial in trials:
    ...
    ptime_txt = 'psychopyBuilder' + expInfo['hz'] + '_' + str(ptime*1000)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if mask.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask.tStartRefresh + 0.016-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if text_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_2.tStartRefresh + 0.016-frameTolerance:
                # keep track of stop time/frame for later
